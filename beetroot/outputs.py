...
# %% auto 0
__all__ = ['Completion', 'emit_stream_output', 'emit_execute_result_output', 'emit_display_data_output']
...
def emit_output_data(data: Dict, stream: io.TextIOBase) -> Optional[Completion]:
