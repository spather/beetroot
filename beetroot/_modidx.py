...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'beetroot.api': { 'beetroot.api.OutputHandler': ('api.html#outputhandler', 'beetroot/api.py'),
            ...
            'beetroot.markdown.cli': { 'beetroot.markdown.cli.MarkdownBackendConfig': ( 'markdown/cli.html#markdownbackendconfig',
                                                                                        'beetroot/markdown/cli.py'),
                                       'beetroot.markdown.cli.MarkdownBackendConfig.configure_arg_parser': ( 'markdown/cli.html#markdownbackendconfig.configure_arg_parser',
                                                                                                             'beetroot/markdown/cli.py'),
                                       'beetroot.markdown.cli.MarkdownBackendConfig.run': ( 'markdown/cli.html#markdownbackendconfig.run',
                                                                                            'beetroot/markdown/cli.py')},
            ...
            'beetroot.markdown.source': { 'beetroot.markdown.source.MarkdownSourceHandler': ( 'markdown/source.html#markdownsourcehandler',
                                          ...
                                          'beetroot.markdown.source.parse_directive_line': ( 'markdown/source.html#parse_directive_line',
                                                                                             'beetroot/markdown/source.py')},
            'beetroot.markdown.transformations': { 'beetroot.markdown.transformations.EscapeUnderscoresWithLatexMath': ( 'markdown/transformations.html#escapeunderscoreswithlatexmath',
                                                                                                                         'beetroot/markdown/transformations.py'),
                                                   'beetroot.markdown.transformations.EscapeUnderscoresWithLatexMath.process_lines': ( 'markdown/transformations.html#escapeunderscoreswithlatexmath.process_lines',
                                                                                                                                       'beetroot/markdown/transformations.py'),
