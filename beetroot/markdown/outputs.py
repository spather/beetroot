# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/markdown/02_outputs.ipynb.

# %% auto 0
__all__ = ['MarkdownCompletion', 'no_op_completion', 'MarkdownOutputHandler']
...
# %% ../../nbs/markdown/02_outputs.ipynb 7
MarkdownCompletion = Callable[[Path], None]

# Define a no-op completion to be used when there is no completion,
# to avoid having to use None
no_op_completion: MarkdownCompletion = lambda _: None

# %% ../../nbs/markdown/02_outputs.ipynb 8
...
# %% ../../nbs/markdown/02_outputs.ipynb 9
class MarkdownOutputHandler(OutputHandler[MarkdownCompletion]):
    ...
    def handle_output(self, output: Dict) -> MarkdownCompletion:
        completion = no_op_completion
